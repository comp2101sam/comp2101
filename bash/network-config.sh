...
# Task 1
# assigning the interface name to a variable
interface_name=$(ip a | awk '/: e/{gsub(/:/,"");print $2}')
# assigning the hostname to a variable

hostname=$(hostname)
# assigning external ip to a variable
externalIP=$(curl -s icanhazip.com)
# assigning external name to a variable
externalName=$(getent hosts $externalIP | awk '{print $2}')
# assigning lan address to a variable
lanAddress=$(ip a s $interface_name | awk '/inet /{gsub(/\/.*/,"");print $2}')
# assigning lan hostname to a variable
lanHostname=$(getent hosts $lanAddress | awk '{print $2}')


# Task 2
# Add variables for the default router's name and IP address
