...
# unpack the tar file to our pictures directory then delete the local copy pf the tar file
test -f ~/Pictures/pics.tgz && tar -x -C ~/Pictures -f ~/Pictures/pics.tgz && rm ~/Pictures/pics.tgz
